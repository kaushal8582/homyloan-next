...
const FixedRequirements = ({ content }) => {
  const data = mergeWithDefaults(defaultRequirements, content);
  return (
    <section className="w-full bg-black py-20 px-6 md:px-12 lg:px-20">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-center text-white text-3xl md:text-4xl font-semibold tracking-wide mb-14">
          {data.heading}
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white rounded-3xl p-8 shadow-md">
            <h3 className="text-lg font-semibold mb-4">{data.fixedTitle}</h3>
            {data.fixedBody && (
          ...
          <div className="bg-[#E6FF4B] rounded-3xl p-8 shadow-md">
            <h3 className="text-lg font-semibold mb-4">{data.armTitle}</h3>
            {data.armBody && (
...
export default FixedRequirements;
