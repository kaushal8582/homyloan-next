...
const FixedvsAdjust = ({ content }) => {
  ...
  return (
    <section className="relative w-full min-h-[70vh] pt-10 sm:min-h-[80vh] lg:min-h-screen overflow-hidden flex items-center justify-center py-20 sm:py-24 lg:py-0">
      {showImage ? (
