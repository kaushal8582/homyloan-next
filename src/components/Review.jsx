...
const DEFAULT_TESTIMONIALS = [
  {
    ...
    role: "Web Developer",
    message:
      "OMG! I cannot believe that I have got a brand new landing page after getting appmax. It was super easy to edit and publish.",
    avatar: "/user1.svg",
  },
  {
    name: "Robert Fox",
    ...
    message:
      "The process was smooth and intuitive. Everything worked exactly as expected.",
    avatar: "/user2.svg",
  },
  {
    name: "Esther Howard",
...
const Review = ({ content }) => {
  ...
  const floatingAvatars = testimonials.map((t, i) => t.avatar?.trim() || DEFAULT_TESTIMONIALS[i % 6].avatar);
  ...
  return (
    <section className="h-screen w-full bg-black text-white py-[10vh] md:py-[14vh] px-4 sm:px-6 relative overflow-hidden">
      {/* Background Image - commented, replaced with video */}
      {/* <img
        src="/VA_BG.svg"
        alt="Self-Employed Mortgages"
      ...
      <h2 className="pt-20 text-[clamp(1.75rem,4vw,2.5rem)] font-semibold text-center mb-[8vh] md:mb-[10vh] relative">
      ...
      <div
        ...
        className="hidden lg:block absolute inset-0 mt-25 pointer-events-none"
      >
          ...
          <SwiperSlide key={i}>
            ...
            >
              ...
              <div className="mt-6 flex items-center justify-center gap-3">
                <img
                  src={item.avatar?.trim() || DEFAULT_TESTIMONIALS[i % 6].avatar}
                  alt={item.name}
