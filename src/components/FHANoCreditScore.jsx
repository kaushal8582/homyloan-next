...
const FHANoCreditScore = ({ content }) => {
  ...
  return (
    <section className="relative w-full min-h-[70vh] sm:min-h-[80vh] lg:min-h-screen overflow-hidden flex items-center justify-center py-20 sm:py-24 lg:py-0">
      ...
      <div className="relative z-10 max-w-5xl px-4 sm:px-6 lg:px-8 text-center text-white mt-12 sm:mt-16 lg:mt-20">
...
export default FHANoCreditScore
